...
export async function register(req: Request, res: Response) {
  ...
  // je vérifie si l'email n'est pas déjà utilisé en base
...
// gestion de la connexion et génération du token jwt
...
// récupération des infos de l'utilisateur actuellement connecté
